...
CREATE DATABASE [BD_Administracion]
 CONTAINMENT = NONE
GO
ALTER DATABASE [BD_Administracion] SET COMPATIBILITY_LEVEL = 140
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [BD_Administracion].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [BD_Administracion] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [BD_Administracion] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [BD_Administracion] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [BD_Administracion] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [BD_Administracion] SET ARITHABORT OFF 
GO
ALTER DATABASE [BD_Administracion] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [BD_Administracion] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [BD_Administracion] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [BD_Administracion] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [BD_Administracion] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [BD_Administracion] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [BD_Administracion] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [BD_Administracion] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [BD_Administracion] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [BD_Administracion] SET  DISABLE_BROKER 
GO
ALTER DATABASE [BD_Administracion] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [BD_Administracion] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [BD_Administracion] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [BD_Administracion] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [BD_Administracion] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [BD_Administracion] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [BD_Administracion] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [BD_Administracion] SET RECOVERY FULL 
GO
ALTER DATABASE [BD_Administracion] SET  MULTI_USER 
GO
ALTER DATABASE [BD_Administracion] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [BD_Administracion] SET DB_CHAINING OFF 
GO
ALTER DATABASE [BD_Administracion] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [BD_Administracion] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [BD_Administracion] SET DELAYED_DURABILITY = DISABLED 
GO
EXEC sys.sp_db_vardecimal_storage_format N'BD_Administracion', N'ON'
GO
ALTER DATABASE [BD_Administracion] SET QUERY_STORE = OFF
GO
...
INSERT [dbo].[Articulo] ([artIdPK], [titulo], [resumen], [contenido], [puntuacionInicial], [visitas], [estado], [tipoArt], [nombreArchivo], [fecha], [noMeGusta], [meGusta]) VALUES (8, N'La nueva generacion', N'La liga campeón 2020', 0x4C61206C6967612063616D7065F36E2032303230, 45, 20, N'rechazado', N'corto', NULL, CAST(N'2020-06-24' AS Date), 63, 78)
...
INSERT [dbo].[Miembro] ([nombreUsuarioPK], [nombre], [apellido], [pesoMiembro], [telefono], [informacionBiografica], [pais], [habilidades], [idiomas], [hobbies], [informacionLaboral], [correo], [merito], [tipo]) VALUES (N'JgViquez', N'Ignacio', N'Viquez', 3, N'432432343', N'Herediano', N'Costa Rica', N'otro', N'Español', N'otro', N'Nada', N'jgViquezR@meme.com', -15, N'periferico')
INSERT [dbo].[Miembro] ([nombreUsuarioPK], [nombre], [apellido], [pesoMiembro], [telefono], [informacionBiografica], [pais], [habilidades], [idiomas], [hobbies], [informacionLaboral], [correo], [merito], [tipo]) VALUES (N'Lucho123', N'Lucho', N'Ramirez', 0, N'', N'', N'China', N'', N'Taiwanes', N'', N'', N'lucho@ramirez.com', 0, N'periferico')
...
INSERT [dbo].[Miembro] ([nombreUsuarioPK], [nombre], [apellido], [pesoMiembro], [telefono], [informacionBiografica], [pais], [habilidades], [idiomas], [hobbies], [informacionLaboral], [correo], [merito], [tipo]) VALUES (N'pepitin', N'Pepito ', N'Grillo', 0, N'9238842332', N'naci en Alemania pero mis papas son de suecia', N'España', N'matematicas, ajedrez, deporte', N'Italiano', N'leer, ejercicio, videojuegos, escribir, otro', N'Trabajo como profesor de lengua en Barcelona', N'pepitin@miedo.com', 0, N'nucleo')
...
INSERT [dbo].[Nucleo_Revisa_Articulo] ([nombreUsuarioFK], [artIdFK], [estadoRevision], [puntuacion], [comentarios], [opinion], [contribucion], [forma]) VALUES (N'Dasc12', 10, N'asignado', NULL, NULL, NULL, NULL, NULL)
...
INSERT [dbo].[Nucleo_Revisa_Articulo] ([nombreUsuarioFK], [artIdFK], [estadoRevision], [puntuacion], [comentarios], [opinion], [contribucion], [forma]) VALUES (N'IvanCh123', 8, N'revisado', 45, N'Hola amigos', 1, 4, 4)
INSERT [dbo].[Nucleo_Revisa_Articulo] ([nombreUsuarioFK], [artIdFK], [estadoRevision], [puntuacion], [comentarios], [opinion], [contribucion], [forma]) VALUES (N'IvanCh123', 10, N'asignado', NULL, NULL, NULL, NULL, NULL)
...
INSERT [dbo].[Nucleo_Revisa_Articulo] ([nombreUsuarioFK], [artIdFK], [estadoRevision], [puntuacion], [comentarios], [opinion], [contribucion], [forma]) VALUES (N'otarola506', 10, N'asignado', NULL, NULL, NULL, NULL, NULL)
...
INSERT [dbo].[Nucleo_Solicita_Articulo] ([nombreUsuarioFK], [artIdFK], [estadoSolicitud]) VALUES (N'Dasc12', 10, N'solicitado')
INSERT [dbo].[Nucleo_Solicita_Articulo] ([nombreUsuarioFK], [artIdFK], [estadoSolicitud]) VALUES (N'IvanCh123', 10, N'aceptado')
INSERT [dbo].[Nucleo_Solicita_Articulo] ([nombreUsuarioFK], [artIdFK], [estadoSolicitud]) VALUES (N'otarola506', 10, N'solicitado')
INSERT [dbo].[Nucleo_Solicita_Articulo] ([nombreUsuarioFK], [artIdFK], [estadoSolicitud]) VALUES (N'pepitin', 10, N'solicitado')
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[AumentarMeritoAutor]
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[Borrar_Categoria] (
	@ID int
...
(@nombreUsuarioFK VARCHAR(50), @infoLaboral VARCHAR(MAX), @infoBiografico VARCHAR(max), @telefono VARCHAR(20), @correo VARCHAR(20), @merito FLOAT)
AS
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[DisminuirMeritoAutor]
	@nombreUsuario varchar(50),
	@aumento int
AS
	Update Miembro
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[ingresarPuntuacionAutor]
	@puntuacion float,
	@miembroID varchar(50)
AS
	UPDATE Perfil
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[Mostrar_Categoria_Articulo](
	@ID int
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[Obtener_CategoriaID] (@nombre varchar(20))
AS
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[ObtenerCorreo](@nombreUsuario varchar(50))
AS
	SELECT P.correo
	FROM Miembro P
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[Recuperar_Categorias]
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[Recuperar_Correos]
AS
BEGIN 
SELECT correo
FROM Perfil
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[RecuperarTodosUsuarios]
AS
SELECT M.nombreUsuarioPK, M.nombre, P.correo, P.merito, M.pesoMiembro
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TRIGGER [dbo].[TR_AU_BorrarRevisiones] ON
[dbo].[Articulo] AFTER UPDATE AS
		IF(UPDATE(estado))
			DECLARE @estadoNuevo VARCHAR(20), @artId INT;
			SELECT @estadoNuevo = (SELECT estado FROM INSERTED)
			SELECT @artId = (SELECT artIdPK FROM INSERTED)
			IF(@estadoNuevo = 'aceptado' OR @estadoNuevo = 'rechazado')
				BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TRIGGER [dbo].[TR_AI_BorrarSolicitud] ON
[dbo].[Nucleo_Revisa_Articulo] AFTER INSERT AS
BEGIN
	DECLARE @artID INT;
	SELECT @artID = (SELECT artIdFK FROM INSERTED)
	DELETE FROM Nucleo_Solicita_Articulo
	WHERE artIdFK= @artID
...
USE [master]
GO
ALTER DATABASE [BD_Administracion] SET  READ_WRITE 
GO
